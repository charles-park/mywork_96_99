...
//[*] SNOW DEPTH SENSOR  22.1184MHz set									   [*]
//[*]	SERIAL INTERFACE SENSOR                                            [*]
//[*]	1 PORT IS SNOW DEPTH SENSOR DATA RECIVE                            [*]
//[*]	1 PORT IS LED's TEMP DATA RECIVE                                   [*]
//[*] 												  Edit Date : 96.12. 2 [*]
//[*]												  Edit By   : Heyon.   [*]
//[*]컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴[*]
//[*] 22.1184MHz set													   [*]
//[*] AMOS CLOUD BOARD USED....											   [*]
//[*] U1-32 -----> JP2-3 jumper											   [*]
//[*]   |		   JP2    PCB TOP VIEW								   	   [*]
//[*]   |          *--*													   [*]
//[*]   |          *--*													   [*]
...
static 			float   Temp         	 = -99999.0;
//[*]컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴[*]
static Sensor_u			real, min1, min10, offset;
static Serial_t			com1, com2, com3;
...
//[*]컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴[*]
#define COM1_ADDR		0x0000	//	INTERNAL
#define COM2_ADDR		0x8000	// 	EXTERNAL
#define COM3_ADDR		0xA000	// 	EXTERNAL
#define WATCH_DOG(x)	x = (1 - x)
//[*]컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴[*]
#define CALL_ADDR		MCR(COM2_ADDR)
#define CALL_ON 		0x00
#define CALL_OFF 		0x02
//[*]컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴[*]
#define THR(x)			(x+0)
#define RBR(x)			(x+0)
#define IER(x)			(x+1)
...
void Init(void)
{
	...
	Led_init();
	write_XDATA(CALL_ADDR,CALL_OFF);
	Serial_init(&com1,INTERNAL,COM1_ADDR,BAUD9600,(DATABIT8|STOPBIT1|NOPARITY));
	Serial_init(&com2,EXTERNAL,COM2_ADDR,BAUD1200,(DATABIT8|STOPBIT1|NOPARITY));
	Serial_init(&com3,EXTERNAL,COM3_ADDR,BAUD2400,(DATABIT8|STOPBIT1|NOPARITY));
...
void main(void)
{
	...
	sensor_struct_init(&offset,ID,0x0C, OFFSET_SCAN);
	while(1)	{
