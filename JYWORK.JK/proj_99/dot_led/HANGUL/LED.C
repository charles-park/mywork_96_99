...
void main(void)
{
	...
	Putch_HanFont("ˆa");    getch();
	Putch_HanFont("a");    getch();
	Putch_HanFont("”a");    getch();
	Putch_HanFont("œa");    getch();
	Putch_HanFont(" a");    getch();
	Putch_HanFont("´e");    getch();
	Putch_HanFont("‘w");    getch();
	Putch_HanFont("Ða");    getch();
	Putch_HanFont("­A");    getch();
	Putch_HanFont("¶a");    getch();
	Putch_HanFont("Ój");    getch();
	Putch_HanFont("¬k");    getch();
